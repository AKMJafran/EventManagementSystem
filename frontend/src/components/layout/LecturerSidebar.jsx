      ...
      <div>
        <div className="mb-10 px-2">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="font-serif text-lg text-teal-900 dark:text-teal-50 leading-tight">Lecturer Portal</h2>
              <p className="text-[10px] uppercase tracking-widest text-on-surface-variant/70 font-semibold">Senior Treasurer</p>
            </div>
          </div>
        </div>
